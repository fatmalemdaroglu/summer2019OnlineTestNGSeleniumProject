...
public abstract class TestBase {
    ...
    @BeforeTest
    public void beforeTest(){//location of report gonna be next to target folder, test-output folder
    ...
    public void afterTest(){
        //write test information from started reporters to thir output
        extentReports.flush();
    }
    ...
    public void teardown(ITestResult result) {
        if(result.getStatus() == ITestResult.FAILURE){
            ...
            try {
                //take screenshot and returns location of that screenshot
                //this method throws IOExcepton (Which is exception)
