...
public class TestNGPractice {
    ...
    @Test
    public void  test(){
        //to verify that expected and actual reslts are same
        ...
        //then on the top right, you will se "download sources" message, click it
    ...
    public void verifyHeadingIsDisplayed(){
        ...
        //Element is not visible-will bwe printed it element is there but not visible
        //assertTrue- method that checks if something is true
        //if it is false you will get exception
