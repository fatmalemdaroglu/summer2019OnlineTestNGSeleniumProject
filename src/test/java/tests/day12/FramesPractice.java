...
public class FramesPractice {
    ...
    public void Test1(){
        ...
        //without switching the frame
        //we can switch to frame based on id, name, index(starting from), web Element
        driver.switchTo().frame("mce_0_ifr");
        //without switching, we can not see inner html document
        //Which one to use? id,name, index, webelement
        //1.id or name
        //2.weblelement driver.findElement(By.cssSelector("iframe[class='some_frame']"));
        //3index [iframe1,iframe2,iframe3....]
