...
//everthing that is comman among pages
//can go here
//for example top menu elements don't belongs to specific page
...
public class BasePage {
    ...
    public BasePage(){
        //this method requires to provide webdriver object for @FinfBy
        //and page class
