...
public class ActionsClassHoverPractice {
    ...
    @Test
    public void Test1() {
        //create object of actions to perform actions(drag and drop, context click, move to specific point,etc)
